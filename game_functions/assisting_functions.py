...
def game_instructions():
    ...
    print(
        "- Yhden pelaajan pelissä pelaaja saa päättää, että pelaako hän etsivän vai rikollisen roolia ja pelaa "
    ...
    print(
        "- Peli päättyy kymmenen kierroksen jälkeen tai kunnes toinen etsivistä saa rikollisen kiinni menemällä "
        "samalle lentokentälle, jossa rikollinen on,")
